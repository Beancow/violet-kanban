...
export default function OrganizationForm({ org, user, onSubmit, onDelete }: { org?: Organization | null, user: any, onSubmit: (event: React.FormEvent<HTMLFormElement>) => Promise<void>, onDelete?: () => Promise<void> }) {
    return (
        <Card size="4" style={{ width: 425, margin: '0 auto' }}>
            <Heading as="h1" size="6" align="center" mb="5">
                {org ? 'Update Organization' : 'Create a New Organization'}
            </Heading>
            ...
            <Form.Root onSubmit={onSubmit}>
                <Flex direction="column" gap="3">
                    ...
                    <Form.Field name="type">
                        ...
                        <Select.Root
                            name="type"
                            defaultValue={org?.type || 'personal'}
                        >
                            <Select.Trigger />
                            <Select.Content>
                    ...
                    <Form.Field name="companyName">
                        ...
                        <Form.Control asChild>
                            <input
                                ...
                                defaultValue={org?.data?.companyName}
                            />
                        </Form.Control>
                    </Form.Field>
